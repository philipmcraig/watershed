# -*- coding: utf-8 -*-
"""
Created on Mon Oct 16 09:12:50 2017
...
shed = 'ArA' # which catchment boundary?
F = []
for mon in range(filenames.shape[1]):
    F.append(ShedFluxes(sheddir,shed,lon,lat,zon_mts[mon],mer_mts[mon]))
...
#f = open(sheddir+'splits_'+shed+'_sscyc.csv','w')
