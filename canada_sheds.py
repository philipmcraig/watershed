...
bounds = pl.array([[-170,-17,-54,72], # Americas, Atlantic/Pacific divide
                    [8,-36,44,42], # Africa/Middle East, Atlantic/Indian divide
                    [88,-26,155,35], # East Asia/Australia, Indian/Pacific divide
                    ])
isect = pl.array([[-113.55,48.50], # Arctic/American intersection
...
shed = 0 # shed corresponds to index of 0-axis in bounds array
...
if shed == 0:
    cn_shp = m.readshapefile("canadaoda_p_1m_v6-0_shp/canadnaoda_p","cn",linewidth=0.5) # North America
    na_shp = m.readshapefile("na_bas_30s_beta","na",linewidth=0.5)
