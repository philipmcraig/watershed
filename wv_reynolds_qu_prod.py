...
u = pl.squeeze(u); q = pl.squeeze(q); surfp = pl.squeeze(surfp)
...
QU_in = newnc.createVariable('Vertically-integrated zonal moisture flux (mean flow)',
                                             pl.float64,('lat','lon'))
QU_in.units = 'kg/m/s'
QU_in.standard_name = 'zonal moisture flux (mean flow)'
QU_in[:,:] = QU_prod
