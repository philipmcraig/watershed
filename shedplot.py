...
amr_flx = [0.16,0.39]; afr_flx = [0.10,0.31,0.08]; eaa_flx = [0.18,0.02]
ara_flx = [0.08,0.09,0.10]; ari_flx = [0.08,0.05,0.02]; arp_flx = [0.06,0.03,0.11]
soa_flx = [0.03,0.27]; soi_flx = [0.22,0.05]; sop_flx = [0.02,0.38,0.04]
...
#
pl.arrow(x1[0],y1[0],1500000,0,fc="none",ec="b",lw=4,head_width=600000,
         head_length=600000,width=9000,head_starts_at_zero=False)
pl.annotate(str(amr_flx[0]),xy=(0.63,0.685),xycoords='figure fraction',
            color='b',size=25)
pl.arrow(x1[1],y1[1],-1500000,0,fc="none",ec="b",lw=4,head_width=600000,
         head_length=600000,width=9000,head_starts_at_zero=False)
pl.annotate('{:.2f}'.format(amr_flx[1]),xy=(0.70,0.485),
            xycoords='figure fraction',color='b',size=25)
            
pl.arrow(x2[0],y2[0],990000,-250000,fc="none",ec="k",lw=4,head_width=600000,
         head_length=700000,width=9000,head_starts_at_zero=False)
pl.annotate('{:.2f}'.format(afr_flx[0]),xy=(0.07,0.66),
            xycoords='figure fraction',color='k',size=25)
pl.arrow(x2[1],y2[1],-2500000,0,fc="none", ec="k",lw=4,head_width=600000,
         head_length=700000,width=9000,head_starts_at_zero=False)
pl.annotate(str(afr_flx[1]),xy=(0.15,0.48),xycoords='figure fraction',
            color='k',size=25)
pl.arrow(x2[2],y2[2],2000000,0,fc="none",ec="k",lw=4,head_width=600000,
         head_length=700000,width=9000,head_starts_at_zero=False)
pl.annotate(str(afr_flx[2]),xy=(0.035,0.33),xycoords='figure fraction',
            color='k',size=25)

pl.arrow(x3[0],y3[0],1700000,0,fc="none",ec="g",lw=4,head_width=600000,
         head_length=700000,width=9000,head_starts_at_zero=False)
pl.annotate(str(eaa_flx[0]),xy=(0.24,0.55),xycoords='figure fraction',
            color='g',size=25)
pl.arrow(x3[1],y3[1],-1000000,-1000000,fc="none",ec="g",lw=4,head_width=600000,
         head_length=700000,width=9000,head_starts_at_zero=False)
pl.annotate(str(eaa_flx[1]),xy=(0.265,0.40),xycoords='figure fraction',
            color='g',size=25)
          
pl.arrow(x4[0],y4[0],450000,-850000,fc="none",ec="r",lw=4,head_width=600000,
         head_length=700000,width=9000,head_starts_at_zero=False)
pl.annotate(str(ara_flx[0]),xy=(0.695,0.81),xycoords='figure fraction',
            color='r',size=25)
pl.arrow(x4[1],y4[1],1600000,0,fc="none",ec="r",lw=4,head_width=650000,
         head_length=650000,width=10000,head_starts_at_zero=False)
pl.annotate(str(ara_flx[1]),xy=(0.245,0.90),xycoords='figure fraction',
            color='r',size=25)
pl.arrow(x4[2],y4[2],1100000,-150000,fc="none",ec="r",lw=4,head_width=650000,
         head_length=650000,width=10000,head_starts_at_zero=False)
pl.annotate('{:.2f}'.format(ara_flx[2]),xy=(0.12,0.77),
            xycoords='figure fraction',color='r',size=25)

pl.arrow(x5[0],y5[0],1100000,250000,fc="none",ec="r",lw=4,head_width=600000,
         head_length=700000,width=9000,head_starts_at_zero=False)
pl.annotate(str(ari_flx[0]),xy=(0.13,0.666),xycoords='figure fraction',
            color='r',size=25,zorder=10)
pl.arrow(x5[1],y5[1],500000,-700000,fc="none",ec="r",lw=4,head_width=600000,
         head_length=700000,width=9000,head_starts_at_zero=False)
pl.annotate(str(ari_flx[1]),xy=(0.19,0.6),xycoords='figure fraction',color='r',
            size=25,zorder=10)
pl.arrow(x5[2],y5[2],0,700000,fc="none",ec="r",lw=4,head_width=600000,
         head_length=700000,width=9000,head_starts_at_zero=False)
pl.annotate(str(ari_flx[2]),xy=(0.245,0.735),xycoords='figure fraction',
            color='r',size=25,zorder=10)

pl.arrow(x6[0],y6[0],900000,-450000,fc="none",ec="r",lw=4,head_width=600000,
         head_length=700000,width=9000,head_starts_at_zero=False)
pl.annotate(str(arp_flx[0]),xy=(0.32,0.65),xycoords='figure fraction',
            color='r',size=25,zorder=10)
pl.arrow(x6[1],y6[1],900000,-510000,fc="none",ec="r",lw=4,head_width=600000,
         head_length=700000,width=9000,head_starts_at_zero=False)
pl.annotate(str(arp_flx[1]),xy=(0.43,0.77),xycoords='figure fraction',
            color='r',size=25,zorder=10)
pl.arrow(x6[2],y6[2],900000,510000,fc="none",ec="r",lw=4,head_width=600000,
         head_length=700000,width=9000,head_starts_at_zero=False)
pl.annotate(str(arp_flx[2]),xy=(0.55,0.80),xycoords='figure fraction',
            color='r',size=25,zorder=10)
  
pl.arrow(x7[0],y7[0],-450000,-750000,fc="none",ec="darkgoldenrod",lw=4,head_width=600000,
         head_length=600000,width=9000,head_starts_at_zero=False)
pl.annotate(str(soa_flx[0]),xy=(0.83,0.44),xycoords='figure fraction',
            color='darkgoldenrod',size=25)
pl.arrow(x7[1],y7[1],0,-750000,fc="none",ec="darkgoldenrod",lw=4,head_width=600000,
         head_length=600000,width=9000,head_starts_at_zero=False)
pl.annotate(str(soa_flx[1]),xy=(0.87,0.33),xycoords='figure fraction',
            color='darkgoldenrod',size=25)

pl.arrow(x8[0],y8[0],0,-750000,fc="none",ec="darkgoldenrod",lw=4,head_width=600000,
         head_length=600000,width=9000,head_starts_at_zero=False)
pl.annotate('{:.2f}'.format(soi_flx[0]),xy=(0.215,0.33),
            xycoords='figure fraction',color='darkgoldenrod',size=25)
pl.arrow(x8[1],y8[1],450000,-750000,fc="none",ec="darkgoldenrod",lw=4,
         head_width=600000,head_length=600000,width=9000,head_starts_at_zero=False)
pl.annotate(str(soi_flx[1]),xy=(0.35,0.275),xycoords='figure fraction',
            color='darkgoldenrod',size=25)

pl.arrow(x9[0],y9[0],650000,650000,fc="none",ec="darkgoldenrod",lw=4,head_width=600000,
         head_length=600000,width=9000,head_starts_at_zero=False)
pl.annotate(str(sop_flx[0]),xy=(0.43,0.38),xycoords='figure fraction',
            color='darkgoldenrod',size=25)
pl.arrow(x9[1],y9[1],0,-750000,fc="none",ec="darkgoldenrod",lw=4,head_width=600000,
         head_length=600000,width=9000,head_starts_at_zero=False)
pl.annotate(str(sop_flx[1]),xy=(0.585,0.32),xycoords='figure fraction',
            color='darkgoldenrod',size=25)
pl.arrow(x9[2],y9[2],650000,0,fc="none",ec="darkgoldenrod",lw=4,head_width=600000,
         head_length=600000,width=9000,head_starts_at_zero=False)
pl.annotate(str(sop_flx[2]),xy=(0.74,0.345),xycoords='figure fraction',
            color='darkgoldenrod',size=25)
...
#            size=30)
#
#pl.arrow(x[-3],y[-3],350000,650000,fc="none", ec="maroon", linewidth = 4, head_width=600000,
...
a,b = m(180,15)
pl.text(a,b,'-0.03',bbox={'facecolor':'white', 'alpha':0.5, 'pad':10},fontsize=30)
a,b = m(320,15)
pl.text(a,b,'-0.51',bbox={'facecolor':'white', 'alpha':0.5, 'pad':10},fontsize=30)
a,b = m(70,-15)
pl.text(a,b,'-0.61',bbox={'facecolor':'white', 'alpha':0.5, 'pad':10},fontsize=30)
a,b = m(100,70)
pl.text(a,b,'0.17',bbox={'facecolor':'white', 'alpha':1.0, 'pad':10},fontsize=30)
a,b = m(180,-55)
pl.text(a,b,'0.98',bbox={'facecolor':'white', 'alpha':0.5, 'pad':10},fontsize=30)
